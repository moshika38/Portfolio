      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 md:p-10">
          ...
          <motion.div
            ...
            className="bg-card-dark border border-white/[0.05] w-full max-w-4xl max-h-[90vh] rounded-3xl lg:rounded-[2rem] overflow-hidden relative shadow-2xl flex flex-col md:flex-row shadow-primary/[0.03]"
          >
            {/* Close Button */}
            <button
              onClick={onClose}
            ...
            <div className="w-full md:w-1/2 h-[250px] md:h-auto relative overflow-hidden">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-card-dark md:hidden" />
              <div className="absolute inset-0 bg-gradient-to-r from-transparent to-card-dark hidden md:block" />
            </div>
            ...
            <div className="w-full md:w-1/2 p-8 md:p-12 overflow-y-auto">
              ...
              <div className="mb-8">
                <h3 className="text-white text-[10px] font-black uppercase tracking-widest mb-4">
                  Technologies
                </h3>
